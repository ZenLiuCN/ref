...
public interface Ref<E> {
    ...
    final class LazyInt32 {
        ...
        //@formatter:off
        public boolean eq(int v) {return this.get() == v;}
        public boolean ne(int v) {return this.get() != v;}
        public boolean gt(int v) {return this.get() > v;}
        public boolean lt(int v) {return this.get() < v;}
        public boolean ge(int v) {return this.get() >= v;}
        public boolean le(int v) {return this.get() <= v;}
        //@formatter:on
    ...
    final class LazyInt64 {
        ...
        //@formatter:off
        public boolean eq(long v) {return this.get() == v;}
        public boolean ne(long v) {return this.get() != v;}
        public boolean gt(long v) {return this.get() > v;}
        public boolean lt(long v) {return this.get() < v;}
        public boolean ge(long v) {return this.get() >= v;}
        public boolean le(long v) {return this.get() <= v;}
        //@formatter:on
    ...
    final class $ {
        ...
        interface KClass {
             ...
             **/
            Lazy<Handle> AnnotationDataGetter = Ref.lazy(() -> $Type.get().findGetter("annotationData", Ref.type("java.lang.Class.AnnotationData").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            Lazy<Handle> AnnotationDataSetter = Ref.lazy(() -> $Type.get().findSetter("annotationData", Ref.type("java.lang.Class.AnnotationData").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private transient volatile sun.reflect.generics.repository.ClassRepository java.lang.Class.genericInfo
             **/
            Lazy<Handle> GenericInfoGetter = Ref.lazy(() -> $Type.get().findGetter("genericInfo", Ref.type("sun.reflect.generics.repository.ClassRepository").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            Lazy<Handle> GenericInfoSetter = Ref.lazy(() -> $Type.get().findSetter("genericInfo", Ref.type("sun.reflect.generics.repository.ClassRepository").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private transient volatile java.util.Map<java.lang.String, T> java.lang.Class.enumConstantDirectory
             **/
            Lazy<Handle> EnumConstantDirectoryGetter = Ref.lazy(() -> $Type.get().findGetter("enumConstantDirectory", Map.class).orElseThrow(() -> new IllegalStateException("No value present")));
            Lazy<Handle> EnumConstantDirectorySetter = Ref.lazy(() -> $Type.get().findSetter("enumConstantDirectory", Map.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private final java.lang.Class<?> java.lang.Class.componentType
             **/
            Lazy<Handle> ComponentTypeGetter = Ref.lazy(() -> $Type.get().findGetter("componentType", Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            Lazy<Handle> ComponentTypeSetter = Ref.lazy(() -> $Type.get().findSetter("componentType", Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private static final int java.lang.Class.ENUM
             **/
            Lazy<Handle.Alive> ENUMGetter = Ref.lazy(() -> $Type.get().findStaticGetter("ENUM", int.class).orElseThrow(() -> new IllegalStateException("No value present")));
            Lazy<Handle.Alive> ENUMSetter = Ref.lazy(() -> $Type.get().findStaticSetter("ENUM", int.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private transient volatile int java.lang.Class.classRedefinedCount
             **/
            Lazy<Handle> ClassRedefinedCountGetter = Ref.lazy(() -> $Type.get().findGetter("classRedefinedCount", int.class).orElseThrow(() -> new IllegalStateException("No value present")));
            Lazy<Handle> ClassRedefinedCountSetter = Ref.lazy(() -> $Type.get().findSetter("classRedefinedCount", int.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private final java.lang.ClassLoader java.lang.Class.classLoader
             **/
            Lazy<Handle> ClassLoaderGetter = Ref.lazy(() -> $Type.get().findGetter("classLoader", ClassLoader.class).orElseThrow(() -> new IllegalStateException("No value present")));
            Lazy<Handle> ClassLoaderSetter = Ref.lazy(() -> $Type.get().findSetter("classLoader", ClassLoader.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private transient volatile java.lang.reflect.Constructor<T> java.lang.Class.cachedConstructor
             **/
            Lazy<Handle> CachedConstructorGetter = Ref.lazy(() -> $Type.get().findGetter("cachedConstructor", Constructor.class).orElseThrow(() -> new IllegalStateException("No value present")));
            Lazy<Handle> CachedConstructorSetter = Ref.lazy(() -> $Type.get().findSetter("cachedConstructor", Constructor.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private transient java.lang.Object java.lang.Class.classData
             **/
            Lazy<Handle> ClassDataGetter = Ref.lazy(() -> $Type.get().findGetter("classData", Object.class).orElseThrow(() -> new IllegalStateException("No value present")));
            Lazy<Handle> ClassDataSetter = Ref.lazy(() -> $Type.get().findSetter("classData", Object.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private transient java.lang.Module java.lang.Class.module
             **/
            Lazy<Handle> ModuleGetter = Ref.lazy(() -> $Type.get().findGetter("module", $Type.get().element()).orElseThrow(() -> new IllegalStateException("No value present")));
            Lazy<Handle> ModuleSetter = Ref.lazy(() -> $Type.get().findSetter("module", $Type.get().element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private transient volatile sun.reflect.annotation.AnnotationType java.lang.Class.annotationType
             **/
            Lazy<Handle> AnnotationTypeGetter = Ref.lazy(() -> $Type.get().findGetter("annotationType", Ref.type("sun.reflect.annotation.AnnotationType").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            Lazy<Handle> AnnotationTypeSetter = Ref.lazy(() -> $Type.get().findSetter("annotationType", Ref.type("sun.reflect.annotation.AnnotationType").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private static final int java.lang.Class.SYNTHETIC
             **/
            Lazy<Handle.Alive> SYNTHETICGetter = Ref.lazy(() -> $Type.get().findStaticGetter("SYNTHETIC", int.class).orElseThrow(() -> new IllegalStateException("No value present")));
            Lazy<Handle.Alive> SYNTHETICSetter = Ref.lazy(() -> $Type.get().findStaticSetter("SYNTHETIC", int.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private transient volatile java.lang.ref.SoftReference<java.lang.Class$ReflectionData<T>> java.lang.Class.reflectionData
             **/
            Lazy<Handle> ReflectionDataGetter = Ref.lazy(() -> $Type.get().findGetter("reflectionData", java.lang.ref.SoftReference.class).orElseThrow(() -> new IllegalStateException("No value present")));
            Lazy<Handle> ReflectionDataSetter = Ref.lazy(() -> $Type.get().findSetter("reflectionData", java.lang.ref.SoftReference.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * transient java.lang.ClassValue$ClassValueMap java.lang.Class.classValueMap
             **/
            Lazy<Handle> ClassValueMapGetter = Ref.lazy(() -> $Type.get().findGetter("classValueMap", Ref.type("java.lang.ClassValue.ClassValueMap").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            Lazy<Handle> ClassValueMapSetter = Ref.lazy(() -> $Type.get().findSetter("classValueMap", Ref.type("java.lang.ClassValue.ClassValueMap").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private static final java.io.ObjectStreamField[] java.lang.Class.serialPersistentFields
             **/
            Lazy<Handle.Alive> SerialPersistentFieldsGetter = Ref.lazy(() -> $Type.get().findStaticGetter("serialPersistentFields", Ref.type("java.io.ObjectStreamField[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            Lazy<Handle.Alive> SerialPersistentFieldsSetter = Ref.lazy(() -> $Type.get().findStaticSetter("serialPersistentFields", Ref.type("java.io.ObjectStreamField[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private transient volatile T[] java.lang.Class.enumConstants
             **/
            Lazy<Handle> EnumConstantsGetter = Ref.lazy(() -> $Type.get().findGetter("enumConstants", Ref.type("java.lang.Object[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            Lazy<Handle> EnumConstantsSetter = Ref.lazy(() -> $Type.get().findSetter("enumConstants", Ref.type("java.lang.Object[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private static final int java.lang.Class.ANNOTATION
             **/
            Lazy<Handle.Alive> ANNOTATIONGetter = Ref.lazy(() -> $Type.get().findStaticGetter("ANNOTATION", int.class).orElseThrow(() -> new IllegalStateException("No value present")));
            Lazy<Handle.Alive> ANNOTATIONSetter = Ref.lazy(() -> $Type.get().findStaticSetter("ANNOTATION", int.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private transient java.lang.String java.lang.Class.name
             **/
            Lazy<Handle> NameGetter = Ref.lazy(() -> $Type.get().findGetter("name", String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            Lazy<Handle> NameSetter = Ref.lazy(() -> $Type.get().findSetter("name", String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private static jdk.internal.reflect.ReflectionFactory java.lang.Class.reflectionFactory
             **/
            Lazy<Handle.Alive> ReflectionFactoryGetter = Ref.lazy(() -> $Type.get().findStaticGetter("reflectionFactory", Ref.type("jdk.internal.reflect.ReflectionFactory").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            Lazy<Handle.Alive> ReflectionFactorySetter = Ref.lazy(() -> $Type.get().findStaticSetter("reflectionFactory", Ref.type("jdk.internal.reflect.ReflectionFactory").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private transient java.lang.String java.lang.Class.packageName
             **/
            Lazy<Handle> PackageNameGetter = Ref.lazy(() -> $Type.get().findGetter("packageName", String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            Lazy<Handle> PackageNameSetter = Ref.lazy(() -> $Type.get().findSetter("packageName", String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private static java.security.ProtectionDomain java.lang.Class.allPermDomain
             **/
            Lazy<Handle.Alive> AllPermDomainGetter = Ref.lazy(() -> $Type.get().findStaticGetter("allPermDomain", java.security.ProtectionDomain.class).orElseThrow(() -> new IllegalStateException("No value present")));
            Lazy<Handle.Alive> AllPermDomainSetter = Ref.lazy(() -> $Type.get().findStaticSetter("allPermDomain", java.security.ProtectionDomain.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private static final java.lang.Class<?>[] java.lang.Class.EMPTY_CLASS_ARRAY
             **/
            Lazy<Handle.Alive> EMPTY_CLASS_ARRAYGetter = Ref.lazy(() -> $Type.get().findStaticGetter("EMPTY_CLASS_ARRAY", Ref.type("java.lang.Class[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            Lazy<Handle.Alive> EMPTY_CLASS_ARRAYSetter = Ref.lazy(() -> $Type.get().findStaticSetter("EMPTY_CLASS_ARRAY", Ref.type("java.lang.Class[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.Module java.lang.Class.getModule()
             **/
            Lazy<Handle> GetModule = Ref.lazy(() -> $Type.get().handle("getModule", $Type.get().element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public boolean java.lang.Class.isSealed()
             **/
            Lazy<Handle> IsSealed = Ref.lazy(() -> $Type.get().handle("isSealed", boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.net.URL java.lang.Class.getResource(java.lang.String)
             **/
            Lazy<Handle> GetResource = Ref.lazy(() -> $Type.get().handle("getResource", java.net.URL.class, String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private boolean java.lang.Class.isLocalOrAnonymousClass()
             **/
            Lazy<Handle> IsLocalOrAnonymousClass = Ref.lazy(() -> $Type.get().handle("isLocalOrAnonymousClass", boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public boolean java.lang.Class.isLocalClass()
             **/
            Lazy<Handle> IsLocalClass = Ref.lazy(() -> $Type.get().handle("isLocalClass", boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public boolean java.lang.Class.isSynthetic()
             **/
            Lazy<Handle> IsSynthetic = Ref.lazy(() -> $Type.get().handle("isSynthetic", boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.String java.lang.Class.getCanonicalName()
             **/
            Lazy<Handle> GetCanonicalName = Ref.lazy(() -> $Type.get().handle("getCanonicalName", String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             ...
             **/
            Lazy<Handle> GetMethod = Ref.lazy(() -> $Type.get().handle("getMethod", Method.class, String.class, Ref.type("java.lang.Class[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private java.lang.reflect.Method[] java.lang.Class.privateGetDeclaredMethods(boolean)
             **/
            Lazy<Handle> PrivateGetDeclaredMethods = Ref.lazy(() -> $Type.get().handle("privateGetDeclaredMethods", Ref.type("java.lang.reflect.Method[]").element(), boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * java.util.List<java.lang.reflect.Method> java.lang.Class.getDeclaredPublicMethods(java.lang.String,java.lang.Class<?>...)
             **/
            Lazy<Handle> GetDeclaredPublicMethods = Ref.lazy(() -> $Type.get().handle("getDeclaredPublicMethods", List.class, String.class, Ref.type("java.lang.Class[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.reflect.Field[] java.lang.Class.getDeclaredFields() throws java.lang.SecurityException
             **/
            Lazy<Handle> GetDeclaredFields = Ref.lazy(() -> $Type.get().handle("getDeclaredFields", Ref.type("java.lang.reflect.Field[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private native java.lang.reflect.Constructor<T>[] java.lang.Class.getDeclaredConstructors0(boolean)
             **/
            Lazy<Handle> GetDeclaredConstructors0 = Ref.lazy(() -> $Type.get().handle("getDeclaredConstructors0", Ref.type("java.lang.reflect.Constructor[]").element(), boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public T java.lang.Class.cast(java.lang.Object)
             **/
            Lazy<Handle> Cast = Ref.lazy(() -> $Type.get().handle("cast", Object.class, Object.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public native boolean java.lang.Class.isInstance(java.lang.Object)
             **/
            Lazy<Handle> IsInstance = Ref.lazy(() -> $Type.get().handle("isInstance", boolean.class, Object.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private boolean java.lang.Class.isDirectSubType(java.lang.Class<?>)
             **/
            Lazy<Handle> IsDirectSubType = Ref.lazy(() -> $Type.get().handle("isDirectSubType", boolean.class, Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.reflect.Method java.lang.Class.getEnclosingMethod() throws java.lang.SecurityException
             **/
            Lazy<Handle> GetEnclosingMethod = Ref.lazy(() -> $Type.get().handle("getEnclosingMethod", Method.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public native java.lang.Object[] java.lang.Class.getSigners()
             **/
            Lazy<Handle> GetSigners = Ref.lazy(() -> $Type.get().handle("getSigners", Ref.type("java.lang.Object[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             ...
             **/
            Lazy<Handle> GetConstructor0 = Ref.lazy(() -> $Type.get().handle("getConstructor0", Constructor.class, Ref.type("java.lang.Class[]").element(), int.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private java.lang.reflect.Field[] java.lang.Class.privateGetPublicFields()
             **/
            Lazy<Handle> PrivateGetPublicFields = Ref.lazy(() -> $Type.get().handle("privateGetPublicFields", Ref.type("java.lang.reflect.Field[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public native boolean java.lang.Class.isInterface()
             **/
            Lazy<Handle> IsInterface = Ref.lazy(() -> $Type.get().handle("isInterface", boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.invoke.TypeDescriptor$OfField java.lang.Class.arrayType()
             **/
            Lazy<Handle> ArrayType = Ref.lazy(() -> $Type.get().handle("arrayType", Ref.type("java.lang.invoke.TypeDescriptor.OfField").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.Class<?> java.lang.Class.arrayType()
             **/
            Lazy<Handle> ArrayType1 = Ref.lazy(() -> $Type.get().handle("arrayType", Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private static java.lang.Class<?> java.lang.Class.toClass(java.lang.reflect.Type)
             **/
            Lazy<Handle.Alive> ToClass = Ref.lazy(() -> $Type.get().findStatic("toClass", Class.class, java.lang.reflect.Type.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private boolean java.lang.Class.hasEnclosingMethodInfo()
             **/
            Lazy<Handle> HasEnclosingMethodInfo = Ref.lazy(() -> $Type.get().handle("hasEnclosingMethodInfo", boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * java.security.ProtectionDomain java.lang.Class.protectionDomain()
             **/
            Lazy<Handle> ProtectionDomain = Ref.lazy(() -> $Type.get().handle("protectionDomain", java.security.ProtectionDomain.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public <U> java.lang.Class<? extends U> java.lang.Class.asSubclass(java.lang.Class<U>)
             **/
            Lazy<Handle> AsSubclass = Ref.lazy(() -> $Type.get().handle("asSubclass", Class.class, Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             ...
             **/
            Lazy<Handle> GetField = Ref.lazy(() -> $Type.get().handle("getField", Field.class, String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.String java.lang.Class.descriptorString()
             **/
            Lazy<Handle> DescriptorString = Ref.lazy(() -> $Type.get().handle("descriptorString", String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private java.lang.reflect.Constructor<T>[] java.lang.Class.privateGetDeclaredConstructors(boolean)
             **/
            Lazy<Handle> PrivateGetDeclaredConstructors = Ref.lazy(() -> $Type.get().handle("privateGetDeclaredConstructors", Ref.type("java.lang.reflect.Constructor[]").element(), boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private java.lang.reflect.Method[] java.lang.Class.privateGetPublicMethods()
             **/
            Lazy<Handle> PrivateGetPublicMethods = Ref.lazy(() -> $Type.get().handle("privateGetPublicMethods", Ref.type("java.lang.reflect.Method[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             ...
             **/
            Lazy<Handle.Alive> ForName0 = Ref.lazy(() -> $Type.get().findStatic("forName0", Class.class, String.class, boolean.class, ClassLoader.class, Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private boolean java.lang.Class.isTopLevelClass()
             **/
            Lazy<Handle> IsTopLevelClass = Ref.lazy(() -> $Type.get().handle("isTopLevelClass", boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             ...
             **/
            Lazy<Handle> NewReflectionData = Ref.lazy(() -> $Type.get().handle("newReflectionData", Ref.type("java.lang.Class.ReflectionData").element(), java.lang.ref.SoftReference.class, int.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private boolean java.lang.Class.isOpenToCaller(java.lang.String,java.lang.Class<?>)
             **/
            Lazy<Handle> IsOpenToCaller = Ref.lazy(() -> $Type.get().handle("isOpenToCaller", boolean.class, String.class, Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private native java.lang.reflect.Method[] java.lang.Class.getDeclaredMethods0(boolean)
             **/
            Lazy<Handle> GetDeclaredMethods0 = Ref.lazy(() -> $Type.get().handle("getDeclaredMethods0", Ref.type("java.lang.reflect.Method[]").element(), boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.reflect.RecordComponent[] java.lang.Class.getRecordComponents()
             **/
            Lazy<Handle> GetRecordComponents = Ref.lazy(() -> $Type.get().handle("getRecordComponents", Ref.type("java.lang.reflect.RecordComponent[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.Class<?> java.lang.Class.getComponentType()
             **/
            Lazy<Handle> GetComponentType = Ref.lazy(() -> $Type.get().handle("getComponentType", Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public native boolean java.lang.Class.isArray()
             **/
            Lazy<Handle> IsArray = Ref.lazy(() -> $Type.get().handle("isArray", boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public native boolean java.lang.Class.isPrimitive()
             **/
            Lazy<Handle> IsPrimitive = Ref.lazy(() -> $Type.get().handle("isPrimitive", boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public boolean java.lang.Class.isAnnotation()
             **/
            Lazy<Handle> IsAnnotation = Ref.lazy(() -> $Type.get().handle("isAnnotation", boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.reflect.Constructor<?>[] java.lang.Class.getDeclaredConstructors() throws java.lang.SecurityException
             **/
            Lazy<Handle> GetDeclaredConstructors = Ref.lazy(() -> $Type.get().handle("getDeclaredConstructors", Ref.type("java.lang.reflect.Constructor[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public boolean java.lang.Class.isAnnotationPresent(java.lang.Class<? extends java.lang.annotation.Annotation>)
             **/
            Lazy<Handle> IsAnnotationPresent = Ref.lazy(() -> $Type.get().handle("isAnnotationPresent", boolean.class, Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * sun.reflect.annotation.AnnotationType java.lang.Class.getAnnotationType()
             **/
            Lazy<Handle> GetAnnotationType = Ref.lazy(() -> $Type.get().handle("getAnnotationType", Ref.type("sun.reflect.annotation.AnnotationType").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private static native void java.lang.Class.registerNatives()
             **/
            Lazy<Handle.Alive> RegisterNatives = Ref.lazy(() -> $Type.get().findStatic("registerNatives", void.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private java.lang.Class$ReflectionData<T> java.lang.Class.reflectionData()
             **/
            Lazy<Handle> ReflectionData = Ref.lazy(() -> $Type.get().handle("reflectionData", Ref.type("java.lang.Class.ReflectionData").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public native boolean java.lang.Class.isAssignableFrom(java.lang.Class<?>)
             **/
            Lazy<Handle> IsAssignableFrom = Ref.lazy(() -> $Type.get().handle("isAssignableFrom", boolean.class, Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.reflect.Method[] java.lang.Class.getDeclaredMethods() throws java.lang.SecurityException
             **/
            Lazy<Handle> GetDeclaredMethods = Ref.lazy(() -> $Type.get().handle("getDeclaredMethods", Ref.type("java.lang.reflect.Method[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.Class<?> java.lang.Class.getDeclaringClass() throws java.lang.SecurityException
             **/
            Lazy<Handle> GetDeclaringClass = Ref.lazy(() -> $Type.get().handle("getDeclaringClass", Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private java.lang.String java.lang.Class.getCanonicalName0()
             **/
            Lazy<Handle> GetCanonicalName0 = Ref.lazy(() -> $Type.get().handle("getCanonicalName0", String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private java.lang.String java.lang.Class.getSimpleBinaryName()
             **/
            Lazy<Handle> GetSimpleBinaryName = Ref.lazy(() -> $Type.get().handle("getSimpleBinaryName", String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.String java.lang.Class.toGenericString()
             **/
            Lazy<Handle> ToGenericString = Ref.lazy(() -> $Type.get().handle("toGenericString", String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private static java.lang.reflect.Field[] java.lang.Class.copyFields(java.lang.reflect.Field[])
             **/
            Lazy<Handle.Alive> CopyFields = Ref.lazy(() -> $Type.get().findStatic("copyFields", Ref.type("java.lang.reflect.Field[]").element(), Ref.type("java.lang.reflect.Field[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.Class<?>[] java.lang.Class.getClasses()
             **/
            Lazy<Handle> GetClasses = Ref.lazy(() -> $Type.get().handle("getClasses", Ref.type("java.lang.Class[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * java.lang.Object java.lang.Class.getClassData()
             **/
            Lazy<Handle> GetClassData = Ref.lazy(() -> $Type.get().handle("getClassData", Object.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private java.lang.Class$AnnotationData java.lang.Class.annotationData()
             **/
            Lazy<Handle> AnnotationData = Ref.lazy(() -> $Type.get().handle("annotationData", Ref.type("java.lang.Class.AnnotationData").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private java.lang.String java.lang.Class.methodToString(java.lang.String,java.lang.Class<?>[])
             **/
            Lazy<Handle> MethodToString = Ref.lazy(() -> $Type.get().handle("methodToString", String.class, String.class, Ref.type("java.lang.Class[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.invoke.TypeDescriptor$OfField java.lang.Class.componentType()
             **/
            Lazy<Handle> ComponentType = Ref.lazy(() -> $Type.get().handle("componentType", type("java.lang.invoke.TypeDescriptor.OfField").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.Class<?> java.lang.Class.componentType()
             **/
            Lazy<Handle> ComponentType1 = Ref.lazy(() -> $Type.get().handle("componentType", Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public static java.lang.Class<?> java.lang.Class.forName(java.lang.String) throws java.lang.ClassNotFoundException
             **/
            Lazy<Handle.Alive> ForName = Ref.lazy(() -> $Type.get().findStatic("forName", Class.class, String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public static java.lang.Class<?> java.lang.Class.forName(java.lang.Module,java.lang.String)
             **/
            Lazy<Handle.Alive> ForName1 = Ref.lazy(() -> $Type.get().findStatic("forName", Class.class, $Type.get().element(), String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             ...
             **/
            Lazy<Handle.Alive> ForName2 = Ref.lazy(() -> $Type.get().findStatic("forName", Class.class, String.class, boolean.class, ClassLoader.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private native java.lang.Class<?>[] java.lang.Class.getPermittedSubclasses0()
             **/
            Lazy<Handle> GetPermittedSubclasses0 = Ref.lazy(() -> $Type.get().handle("getPermittedSubclasses0", Ref.type("java.lang.Class[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public boolean java.lang.Class.isRecord()
             **/
            Lazy<Handle> IsRecord = Ref.lazy(() -> $Type.get().handle("isRecord", boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             ...
             **/
            Lazy<Handle> GetDeclaredConstructor = Ref.lazy(() -> $Type.get().handle("getDeclaredConstructor", Constructor.class, Ref.type("java.lang.Class[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private sun.reflect.generics.factory.GenericsFactory java.lang.Class.getFactory()
             **/
            Lazy<Handle> GetFactory = Ref.lazy(() -> $Type.get().handle("getFactory", Ref.type("sun.reflect.generics.factory.GenericsFactory").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.annotation.Annotation[] java.lang.Class.getAnnotations()
             **/
            Lazy<Handle> GetAnnotations = Ref.lazy(() -> $Type.get().handle("getAnnotations", Ref.type("java.lang.annotation.Annotation[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private native java.lang.Class<?> java.lang.Class.getNestHost0()
             **/
            Lazy<Handle> GetNestHost0 = Ref.lazy(() -> $Type.get().handle("getNestHost0", Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private java.lang.reflect.Field java.lang.Class.getField0(java.lang.String)
             **/
            Lazy<Handle> GetField0 = Ref.lazy(() -> $Type.get().handle("getField0", Field.class, String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * native void java.lang.Class.setSigners(java.lang.Object[])
             **/
            Lazy<Handle> SetSigners = Ref.lazy(() -> $Type.get().handle("setSigners", void.class, Ref.type("java.lang.Object[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private java.lang.String java.lang.Class.getSimpleName0()
             **/
            Lazy<Handle> GetSimpleName0 = Ref.lazy(() -> $Type.get().handle("getSimpleName0", String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private native java.security.ProtectionDomain java.lang.Class.getProtectionDomain0()
             **/
            Lazy<Handle> GetProtectionDomain0 = Ref.lazy(() -> $Type.get().handle("getProtectionDomain0", java.security.ProtectionDomain.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private native java.lang.Class<?> java.lang.Class.getDeclaringClass0()
             **/
            Lazy<Handle> GetDeclaringClass0 = Ref.lazy(() -> $Type.get().handle("getDeclaringClass0", Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public <A extends java.lang.annotation.Annotation> A[] java.lang.Class.getDeclaredAnnotationsByType(java.lang.Class<A>)
             **/
            Lazy<Handle> GetDeclaredAnnotationsByType = Ref.lazy(() -> $Type.get().handle("getDeclaredAnnotationsByType", Ref.type("java.lang.annotation.Annotation[]").element(), Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private static void java.lang.Class.addAll(java.util.Collection<java.lang.reflect.Field>,java.lang.reflect.Field[])
             **/
            Lazy<Handle.Alive> AddAll = Ref.lazy(() -> $Type.get().findStatic("addAll", void.class, Collection.class, Ref.type("java.lang.reflect.Field[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * java.lang.ClassLoader java.lang.Class.getClassLoader0()
             **/
            Lazy<Handle> GetClassLoader0 = Ref.lazy(() -> $Type.get().handle("getClassLoader0", ClassLoader.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.String java.lang.Class.toString()
             **/
            Lazy<Handle> ToString = Ref.lazy(() -> $Type.get().handle("toString", String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.reflect.Type java.lang.Class.getGenericSuperclass()
             **/
            Lazy<Handle> GetGenericSuperclass = Ref.lazy(() -> $Type.get().handle("getGenericSuperclass", java.lang.reflect.Type.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * T[] java.lang.Class.getEnumConstantsShared()
             **/
            Lazy<Handle> GetEnumConstantsShared = Ref.lazy(() -> $Type.get().handle("getEnumConstantsShared", Ref.type("java.lang.Object[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private java.lang.Class<?> java.lang.Class.elementType()
             **/
            Lazy<Handle> ElementType = Ref.lazy(() -> $Type.get().handle("elementType", Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * native byte[] java.lang.Class.getRawAnnotations()
             **/
            Lazy<Handle> GetRawAnnotations = Ref.lazy(() -> $Type.get().handle("getRawAnnotations", byte[][].class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private native java.lang.Class<?>[] java.lang.Class.getNestMembers0()
             **/
            Lazy<Handle> GetNestMembers0 = Ref.lazy(() -> $Type.get().handle("getNestMembers0", Ref.type("java.lang.Class[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.String java.lang.Class.getName()
             **/
            Lazy<Handle> GetName = Ref.lazy(() -> $Type.get().handle("getName", String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * static java.lang.String java.lang.Class.typeVarBounds(java.lang.reflect.TypeVariable<?>)
             **/
            Lazy<Handle.Alive> TypeVarBounds = Ref.lazy(() -> $Type.get().findStatic("typeVarBounds", String.class, TypeVariable.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             ...
             **/
            Lazy<Handle.Alive> SearchMethods = Ref.lazy(() -> $Type.get().findStatic("searchMethods", Method.class, Ref.type("java.lang.reflect.Method[]").element(), String.class, Ref.type("java.lang.Class[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private static native boolean java.lang.Class.desiredAssertionStatus0(java.lang.Class<?>)
             **/
            Lazy<Handle.Alive> DesiredAssertionStatus0 = Ref.lazy(() -> $Type.get().findStatic("desiredAssertionStatus0", boolean.class, Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private native boolean java.lang.Class.isRecord0()
             **/
            Lazy<Handle> IsRecord0 = Ref.lazy(() -> $Type.get().handle("isRecord0", boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.util.Optional<java.lang.constant.ClassDesc> java.lang.Class.describeConstable()
             **/
            Lazy<Handle> DescribeConstable = Ref.lazy(() -> $Type.get().handle("describeConstable", Optional.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public boolean java.lang.Class.isMemberClass()
             **/
            Lazy<Handle> IsMemberClass = Ref.lazy(() -> $Type.get().handle("isMemberClass", boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private java.lang.PublicMethods$MethodList java.lang.Class.getMethodsRecursive(java.lang.String,java.lang.Class<?>[],boolean)
             **/
            Lazy<Handle> GetMethodsRecursive = Ref.lazy(() -> $Type.get().handle("getMethodsRecursive", Ref.type("java.lang.PublicMethods.MethodList").element(), String.class, Ref.type("java.lang.Class[]").element(), boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private native java.lang.Object[] java.lang.Class.getEnclosingMethod0()
             **/
            Lazy<Handle> GetEnclosingMethod0 = Ref.lazy(() -> $Type.get().handle("getEnclosingMethod0", Ref.type("java.lang.Object[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.Class<?>[] java.lang.Class.getPermittedSubclasses()
             **/
            Lazy<Handle> GetPermittedSubclasses = Ref.lazy(() -> $Type.get().handle("getPermittedSubclasses", Ref.type("java.lang.Class[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private static <U> java.lang.reflect.Constructor<U>[] java.lang.Class.copyConstructors(java.lang.reflect.Constructor<U>[])
             **/
            Lazy<Handle.Alive> CopyConstructors = Ref.lazy(() -> $Type.get().findStatic("copyConstructors", Ref.type("java.lang.reflect.Constructor[]").element(), Ref.type("java.lang.reflect.Constructor[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.reflect.TypeVariable<java.lang.Class<T>>[] java.lang.Class.getTypeParameters()
             **/
            Lazy<Handle> GetTypeParameters = Ref.lazy(() -> $Type.get().handle("getTypeParameters", Ref.type("java.lang.reflect.TypeVariable[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private static boolean java.lang.Class.arrayContentsEq(java.lang.Object[],java.lang.Object[])
             **/
            Lazy<Handle.Alive> ArrayContentsEq = Ref.lazy(() -> $Type.get().findStatic("arrayContentsEq", boolean.class, Ref.type("java.lang.Object[]").element(), Ref.type("java.lang.Object[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.Package java.lang.Class.getPackage()
             **/
            Lazy<Handle> GetPackage = Ref.lazy(() -> $Type.get().handle("getPackage", Package.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.Class<?> java.lang.Class.getNestHost()
             **/
            Lazy<Handle> GetNestHost = Ref.lazy(() -> $Type.get().handle("getNestHost", Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.Class<?>[] java.lang.Class.getInterfaces()
             **/
            Lazy<Handle> GetInterfaces = Ref.lazy(() -> $Type.get().handle("getInterfaces", Ref.type("java.lang.Class[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private java.lang.Class<?>[] java.lang.Class.getInterfaces(boolean)
             **/
            Lazy<Handle> GetInterfaces1 = Ref.lazy(() -> $Type.get().handle("getInterfaces", Ref.type("java.lang.Class[]").element(), boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.reflect.AnnotatedType[] java.lang.Class.getAnnotatedInterfaces()
             **/
            Lazy<Handle> GetAnnotatedInterfaces = Ref.lazy(() -> $Type.get().handle("getAnnotatedInterfaces", Ref.type("java.lang.reflect.AnnotatedType[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private static java.lang.reflect.Method[] java.lang.Class.copyMethods(java.lang.reflect.Method[])
             **/
            Lazy<Handle.Alive> CopyMethods = Ref.lazy(() -> $Type.get().findStatic("copyMethods", Ref.type("java.lang.reflect.Method[]").element(), Ref.type("java.lang.reflect.Method[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public T java.lang.Class.newInstance() throws java.lang.InstantiationException,java.lang.IllegalAccessException
             **/
            Lazy<Handle> NewInstance = Ref.lazy(() -> $Type.get().handle("newInstance", Object.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private native java.lang.reflect.Field[] java.lang.Class.getDeclaredFields0(boolean)
             **/
            Lazy<Handle> GetDeclaredFields0 = Ref.lazy(() -> $Type.get().handle("getDeclaredFields0", Ref.type("java.lang.reflect.Field[]").element(), boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private static jdk.internal.reflect.ReflectionFactory java.lang.Class.getReflectionFactory()
             **/
            Lazy<Handle.Alive> GetReflectionFactory = Ref.lazy(() -> $Type.get().findStatic("getReflectionFactory", Ref.type("jdk.internal.reflect.ReflectionFactory").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.reflect.Field[] java.lang.Class.getFields() throws java.lang.SecurityException
             **/
            Lazy<Handle> GetFields = Ref.lazy(() -> $Type.get().handle("getFields", Ref.type("java.lang.reflect.Field[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private sun.reflect.generics.repository.ClassRepository java.lang.Class.getGenericInfo()
             **/
            Lazy<Handle> GetGenericInfo = Ref.lazy(() -> $Type.get().handle("getGenericInfo", Ref.type("sun.reflect.generics.repository.ClassRepository").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public <A extends java.lang.annotation.Annotation> A java.lang.Class.getAnnotation(java.lang.Class<A>)
             **/
            Lazy<Handle> GetAnnotation = Ref.lazy(() -> $Type.get().handle("getAnnotation", Annotation.class, Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public <A extends java.lang.annotation.Annotation> A java.lang.Class.getDeclaredAnnotation(java.lang.Class<A>)
             **/
            Lazy<Handle> GetDeclaredAnnotation = Ref.lazy(() -> $Type.get().handle("getDeclaredAnnotation", Annotation.class, Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.String java.lang.Class.getSimpleName()
             **/
            Lazy<Handle> GetSimpleName = Ref.lazy(() -> $Type.get().handle("getSimpleName", String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.String java.lang.Class.getPackageName()
             **/
            Lazy<Handle> GetPackageName = Ref.lazy(() -> $Type.get().handle("getPackageName", String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.reflect.Method[] java.lang.Class.getMethods() throws java.lang.SecurityException
             **/
            Lazy<Handle> GetMethods = Ref.lazy(() -> $Type.get().handle("getMethods", Ref.type("java.lang.reflect.Method[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
             ...
             **/
            Lazy<Handle> GetProtectionDomain = Ref.lazy(() -> $Type.get().handle("getProtectionDomain", java.security.ProtectionDomain.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private native java.lang.Class<?>[] java.lang.Class.getInterfaces0()
             **/
            Lazy<Handle> GetInterfaces0 = Ref.lazy(() -> $Type.get().handle("getInterfaces0", Ref.type("java.lang.Class[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public boolean java.lang.Class.desiredAssertionStatus()
             **/
            Lazy<Handle> DesiredAssertionStatus = Ref.lazy(() -> $Type.get().handle("desiredAssertionStatus", boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * native jdk.internal.reflect.ConstantPool java.lang.Class.getConstantPool()
             **/
            Lazy<Handle> GetConstantPool = Ref.lazy(() -> $Type.get().handle("getConstantPool", Ref.type("jdk.internal.reflect.ConstantPool").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.Class<?>[] java.lang.Class.getNestMembers()
             **/
            Lazy<Handle> GetNestMembers = Ref.lazy(() -> $Type.get().handle("getNestMembers", Ref.type("java.lang.Class[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             ...
             **/
            Lazy<Handle> GetDeclaredAnnotationMap = Ref.lazy(() -> $Type.get().handle("getDeclaredAnnotationMap", Map.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * static native java.lang.Class<?> java.lang.Class.getPrimitiveClass(java.lang.String)
             **/
            Lazy<Handle.Alive> GetPrimitiveClass = Ref.lazy(() -> $Type.get().findStatic("getPrimitiveClass", Class.class, String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.reflect.Type[] java.lang.Class.getGenericInterfaces()
             **/
            Lazy<Handle> GetGenericInterfaces = Ref.lazy(() -> $Type.get().handle("getGenericInterfaces", Ref.type("java.lang.reflect.Type[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.ClassLoader java.lang.Class.getClassLoader()
             **/
            Lazy<Handle> GetClassLoader = Ref.lazy(() -> $Type.get().handle("getClassLoader", ClassLoader.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private native java.lang.String java.lang.Class.getSimpleBinaryName0()
             **/
            Lazy<Handle> GetSimpleBinaryName0 = Ref.lazy(() -> $Type.get().handle("getSimpleBinaryName0", String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.annotation.Annotation[] java.lang.Class.getDeclaredAnnotations()
             **/
            Lazy<Handle> GetDeclaredAnnotations = Ref.lazy(() -> $Type.get().handle("getDeclaredAnnotations", Ref.type("java.lang.annotation.Annotation[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * boolean java.lang.Class.casAnnotationType(sun.reflect.annotation.AnnotationType,sun.reflect.annotation.AnnotationType)
             **/
            Lazy<Handle> CasAnnotationType = Ref.lazy(() -> $Type.get().handle("casAnnotationType", boolean.class, Ref.type("sun.reflect.annotation.AnnotationType").element(), Ref.type("sun.reflect.annotation.AnnotationType").element()).orElseThrow(() -> new IllegalStateException("No value present")));
             ...
             **/
            Lazy<Handle> GetAnnotationsByType = Ref.lazy(() -> $Type.get().handle("getAnnotationsByType", Ref.type("java.lang.annotation.Annotation[]").element(), Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.reflect.Constructor<?>[] java.lang.Class.getConstructors() throws java.lang.SecurityException
             **/
            Lazy<Handle> GetConstructors = Ref.lazy(() -> $Type.get().handle("getConstructors", Ref.type("java.lang.reflect.Constructor[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private java.lang.reflect.Field[] java.lang.Class.privateGetDeclaredFields(boolean)
             **/
            Lazy<Handle> PrivateGetDeclaredFields = Ref.lazy(() -> $Type.get().handle("privateGetDeclaredFields", Ref.type("java.lang.reflect.Field[]").element(), boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.reflect.AnnotatedType java.lang.Class.getAnnotatedSuperclass()
             **/
            Lazy<Handle> GetAnnotatedSuperclass = Ref.lazy(() -> $Type.get().handle("getAnnotatedSuperclass", AnnotatedType.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private static java.lang.reflect.Field java.lang.Class.searchFields(java.lang.reflect.Field[],java.lang.String)
             **/
            Lazy<Handle.Alive> SearchFields = Ref.lazy(() -> $Type.get().findStatic("searchFields", Field.class, Ref.type("java.lang.reflect.Field[]").element(), String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public native int java.lang.Class.getModifiers()
             **/
            Lazy<Handle> GetModifiers = Ref.lazy(() -> $Type.get().handle("getModifiers", int.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.String java.lang.Class.getTypeName()
             **/
            Lazy<Handle> GetTypeName = Ref.lazy(() -> $Type.get().handle("getTypeName", String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.reflect.Constructor<?> java.lang.Class.getEnclosingConstructor() throws java.lang.SecurityException
             **/
            Lazy<Handle> GetEnclosingConstructor = Ref.lazy(() -> $Type.get().handle("getEnclosingConstructor", Constructor.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public boolean java.lang.Class.isNestmateOf(java.lang.Class<?>)
             **/
            Lazy<Handle> IsNestmateOf = Ref.lazy(() -> $Type.get().handle("isNestmateOf", boolean.class, Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private native java.lang.reflect.RecordComponent[] java.lang.Class.getRecordComponents0()
             **/
            Lazy<Handle> GetRecordComponents0 = Ref.lazy(() -> $Type.get().handle("getRecordComponents0", Ref.type("java.lang.reflect.RecordComponent[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public native java.lang.Class<? super T> java.lang.Class.getSuperclass()
             **/
            Lazy<Handle> GetSuperclass = Ref.lazy(() -> $Type.get().handle("getSuperclass", Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             ...
             **/
            Lazy<Handle> GetDeclaredField = Ref.lazy(() -> $Type.get().handle("getDeclaredField", Field.class, String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * java.util.Map<java.lang.String, T> java.lang.Class.enumConstantDirectory()
             **/
            Lazy<Handle> EnumConstantDirectory = Ref.lazy(() -> $Type.get().handle("enumConstantDirectory", Map.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.io.InputStream java.lang.Class.getResourceAsStream(java.lang.String)
             **/
            Lazy<Handle> GetResourceAsStream = Ref.lazy(() -> $Type.get().handle("getResourceAsStream", java.io.InputStream.class, String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private java.lang.Class$EnclosingMethodInfo java.lang.Class.getEnclosingMethodInfo()
             **/
            Lazy<Handle> GetEnclosingMethodInfo = Ref.lazy(() -> $Type.get().handle("getEnclosingMethodInfo", Ref.type("java.lang.Class.EnclosingMethodInfo").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             ...
             **/
            Lazy<Handle> GetDeclaredMethod = Ref.lazy(() -> $Type.get().handle("getDeclaredMethod", Method.class, String.class, Ref.type("java.lang.Class[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * native byte[] java.lang.Class.getRawTypeAnnotations()
             **/
            Lazy<Handle> GetRawTypeAnnotations = Ref.lazy(() -> $Type.get().handle("getRawTypeAnnotations", byte[][].class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public boolean java.lang.Class.isEnum()
             **/
            Lazy<Handle> IsEnum = Ref.lazy(() -> $Type.get().handle("isEnum", boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private java.lang.String java.lang.Class.cannotCastMsg(java.lang.Object)
             **/
            Lazy<Handle> CannotCastMsg = Ref.lazy(() -> $Type.get().handle("cannotCastMsg", String.class, Object.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             ...
             **/
            Lazy<Handle> GetConstructor = Ref.lazy(() -> $Type.get().handle("getConstructor", Constructor.class, Ref.type("java.lang.Class[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public T[] java.lang.Class.getEnumConstants()
             **/
            Lazy<Handle> GetEnumConstants = Ref.lazy(() -> $Type.get().handle("getEnumConstants", Ref.type("java.lang.Object[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public native boolean java.lang.Class.isHidden()
             **/
            Lazy<Handle> IsHidden = Ref.lazy(() -> $Type.get().handle("isHidden", boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private native java.lang.String java.lang.Class.initClassName()
             **/
            Lazy<Handle> InitClassName = Ref.lazy(() -> $Type.get().handle("initClassName", String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private java.lang.String java.lang.Class.resolveName(java.lang.String)
             **/
            Lazy<Handle> ResolveName = Ref.lazy(() -> $Type.get().handle("resolveName", String.class, String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.Class<?>[] java.lang.Class.getDeclaredClasses() throws java.lang.SecurityException
             **/
            Lazy<Handle> GetDeclaredClasses = Ref.lazy(() -> $Type.get().handle("getDeclaredClasses", Ref.type("java.lang.Class[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * static byte[] java.lang.Class.getExecutableTypeAnnotationBytes(java.lang.reflect.Executable)
             **/
            Lazy<Handle.Alive> GetExecutableTypeAnnotationBytes = Ref.lazy(() -> $Type.get().findStatic("getExecutableTypeAnnotationBytes", byte[][].class, Executable.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private native java.lang.String java.lang.Class.getGenericSignature0()
             **/
            Lazy<Handle> GetGenericSignature0 = Ref.lazy(() -> $Type.get().handle("getGenericSignature0", String.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private native java.lang.Class<?>[] java.lang.Class.getDeclaredClasses0()
             **/
            Lazy<Handle> GetDeclaredClasses0 = Ref.lazy(() -> $Type.get().handle("getDeclaredClasses0", Ref.type("java.lang.Class[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
             ...
             **/
            Lazy<Handle> IsAnonymousClass = Ref.lazy(() -> $Type.get().handle("isAnonymousClass", boolean.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private java.lang.reflect.Method java.lang.Class.getMethod0(java.lang.String,java.lang.Class<?>[])
             **/
            Lazy<Handle> GetMethod0 = Ref.lazy(() -> $Type.get().handle("getMethod0", Method.class, String.class, Ref.type("java.lang.Class[]").element()).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * public java.lang.Class<?> java.lang.Class.getEnclosingClass() throws java.lang.SecurityException
             **/
            Lazy<Handle> GetEnclosingClass = Ref.lazy(() -> $Type.get().handle("getEnclosingClass", Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private java.lang.Class$AnnotationData java.lang.Class.createAnnotationData(int)
             **/
            Lazy<Handle> CreateAnnotationData = Ref.lazy(() -> $Type.get().handle("createAnnotationData", Ref.type("java.lang.Class.AnnotationData").element(), int.class).orElseThrow(() -> new IllegalStateException("No value present")));
            /**
             * private java.lang.Class(java.lang.ClassLoader,java.lang.Class<?>)
             **/
            Lazy<Handle.Alive> CREATE = Ref.lazy(() -> $Type.get().findConstructor(ClassLoader.class, Class.class).orElseThrow(() -> new IllegalStateException("No value present")));
        }
        //endregion
    }
    ...
    interface Acc<T extends AccessibleObject> extends Ref<T> {
